...
import PutScreen from "~/components/kv/put"
import GetScreen from "~/components/kv/get"
import DeleteScreen from "~/components/kv/delete"
import GetPanel from "~/components/kv/get-panel"
import PutPanel from "~/components/kv/put-panel"
import DeletePanel from "~/components/kv/delete-panel"
                ...
                >
                  ...
                  >
                    <div className="px-1 py-1 ">
                      {options.map((option) => (
                        <Menu.Item disabled={option === selected}>
                          {({ active }) => (
                            <button
                              className={`${
                                active
